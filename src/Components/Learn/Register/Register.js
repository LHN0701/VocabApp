        ...
        <div className='formtong'>
          <div className='birthday'>
            ...
            <div className='form2'>
              <div className='email'>
                <p >Account</p>
                <input placeholder='Enter your email'className='input2' onChange={(e) => {setAccount(e.target.value)}}></input> 
              </div>
              <div className='user'>
                <p>User Name</p>
                <input placeholder='Enter your name' className='input2' onChange={(e) => {setName(e.target.value)}}></input> 
              </div> 
              <div className='password'>
                <p>Password</p>
                <input   placeholder='Enter your pasword' className='input2' onChange={(e) => {setPassword(e.target.value)}}></input> 
              </div>     
