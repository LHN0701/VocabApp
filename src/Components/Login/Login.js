  ...
  return (
    <div className='Login'>
        ...
        <div className='Loginn'>
          ...
          <input placeholder='Enter your email' className='login-input' onChange={(event) => {SetAccount(event.target.value)}}/>
          <p> Account </p>
          
          <input placeholder='Enter your password' className='login-input' type={'password'} onChange={(event) => {SetPassword(event.target.value)}}/>
          <div className='pass'>
            <p>Password </p>
